...
export default {
  ...
  computed: {
    ...
    getStateName: function (){
      let state =  this.getEventStateById(this.preEvent.state)
      return state ? state.name : ''
    },
    getStateStyle: function () {
      return 'background-color:' + this.getEventStateBgColor(this.preEvent.state) + "; color: " + this.getEventStateColor(this.preEvent.state);
    },
