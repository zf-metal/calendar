 ...
 * @link
 */
class EventTypeController extends AbstractActionController
{

    const ENTITY = \ZfMetal\Calendar\Entity\EventType::class;
    ...
    {
        $this->layoutHelper()->setPageTitle("Tipos de evento");
