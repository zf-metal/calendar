...
namespace DoctrineORMModule\Proxy\__CG__\ZfMetal\Security\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \ZfMetal\Security\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ZfMetal\\Security\\Entity\\User' . "\0" . 'id', '' . "\0" . 'ZfMetal\\Security\\Entity\\User' . "\0" . 'active', '' . "\0" . 'ZfMetal\\Security\\Entity\\User' . "\0" . 'name', '' . "\0" . 'ZfMetal\\Security\\Entity\\User' . "\0" . 'username', '' . "\0" . 'ZfMetal\\Security\\Entity\\User' . "\0" . 'password', '' . "\0" . 'ZfMetal\\Security\\Entity\\User' . "\0" . 'email', '' . "\0" . 'ZfMetal\\Security\\Entity\\User' . "\0" . 'phone', '' . "\0" . 'ZfMetal\\Security\\Entity\\User' . "\0" . 'img', '' . "\0" . 'ZfMetal\\Security\\Entity\\User' . "\0" . 'createdAt', '' . "\0" . 'ZfMetal\\Security\\Entity\\User' . "\0" . 'updatedAt', '' . "\0" . 'ZfMetal\\Security\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'ZfMetal\\Security\\Entity\\User' . "\0" . 'groups'];
        }
